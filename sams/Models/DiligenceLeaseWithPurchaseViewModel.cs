...
{
    public class DiligenceLeaseWithPurchaseViewModel
    {
        public int DiligenceLeaseWithPurchaseId { get; set; }
        ...
        public DateTime? OptionPurchaseDate { get; set; }
        public DateTime? ClosingDate { get; set; }
        public List<UserViewModel> EmployeeList { get; set; }
    }
}
