...
{
    public class DiligenceDispositionsViewModel 
    {
        ...
        public string Rent_SaleLeaseBack { get; set; }
        public string Term_SaleLeaseBack { get; set; }
        public int LeaseType_SaleLeaseBack { get; set; }
        public DateTime? LeaseCommencementDate_SaleLeaseBack { get; set; }
        public List<LeaseTypeModel> LeaseTypeList_SaleLeaseBack { get; set; }
        public DiligenceDispositionsViewModel LeaseTypeList_PurchaseLeaseBack { get; set; }
